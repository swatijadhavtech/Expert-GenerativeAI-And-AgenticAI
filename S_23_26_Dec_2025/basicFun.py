...
# Text Input
user_name = st.sidebar.text_input("What is your name?", "Swati Jadhav")

# Slider
age = st.sidebar.slider("Select your age", 0, 100, 40)

# Selectbox
favorite_color = st.sidebar.selectbox("What is your favorite color?", ["Blue", "Pink", "Green", "Yellow"])
